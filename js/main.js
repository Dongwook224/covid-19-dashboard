var isPlay = true, isMousedown = false;
...
function start( e ){	
	...
	if ( ! Detector.webgl ) {
		...
		//mapIndexedImage.src = 'images/map_indexed.png'; //원본
		mapIndexedImage.src = 'images/11.jpg'; // 일반 인터넷에있는거
		//mapIndexedImage.src = 'images/A_small.png'; //잘라서붙인거(최 차장님꺼)

		mapIndexedImage.onload = function() {
			mapOutlineImage = new Image();
			mapOutlineImage.src = 'images/map_outline.png';
			//mapOutlineImage.src = 'images/map_indexed.png';
...
var Selection = function(){
	...
	this.selectedCountry = 'Korea, Republic of';
...
function initScene() {
	...
	light1 = new THREE.SpotLight( 0xeeeeee, 1 );
	light1.position.x = 730; 
	light1.position.y = 520;
	light1.position.z = 10025;
	...
	//THREE.ImageUtils.loadTexture( 'images/earthmap1k.jpg' );
	...
	var meshPhongMaterial = new THREE.MeshPhongMaterial({ map: indexedMapTexture, overdraw: true });		
...
// 			specular: 	0x333333,
	...
	sphere = new THREE.Mesh( new THREE.SphereGeometry( 100, 40, 40 ), meshPhongMaterial );
